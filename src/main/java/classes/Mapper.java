...
public class Mapper {
    ...
    public class offerInfo {
        ...
        // get site id return string
        public String getSiteID() {
            return siteID;
        }
		
		// get currency return string
        public String getCurrency() {
            return currency;
        }
		
		// get language return string
	...
	// user info class definition
    public class userInfo {
        public String userId="";
        public persona persona = null;

        // get user id return string
    ...
    public class offers {
        ...
        public class Hotel {
            ...
            public class destination {
                ...
                // get region id return string
                public String getRegionID() {
                    return regionID;
                }

				// get long name return string
                public String getLongName() {
                    return longName;
                }

				// get country return string
                public String getCountry() {
                    return country;
                }

				// get province return string
                public String getProvince() {
                    return province;
                }

				// get city id return string
